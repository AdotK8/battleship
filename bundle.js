...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ gameboard)\n/* harmony export */ });\n/* harmony import */ var _ship__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./ship */ \"./src/ship.js\");\n\n\n\nclass gameboard {\n  constructor() {\n    this.misses = {};\n  }\n  createShip(size, coords) {\n    _ship__WEBPACK_IMPORTED_MODULE_0__.ships.push(new _ship__WEBPACK_IMPORTED_MODULE_0__[\"default\"](size, coords));\n  }\n\n  recieveAttack(attackCoords) {\n    let preHits = this.getTotalHits();\n\n    for (let i = 0; i <= _ship__WEBPACK_IMPORTED_MODULE_0__.ships.length - 1; i++) {\n      for (let j = 0; j <= _ship__WEBPACK_IMPORTED_MODULE_0__.ships[i].size - 1; j++) {\n        if (attackCoords.toString() == _ship__WEBPACK_IMPORTED_MODULE_0__.ships[i].coords[j].toString()) {\n          _ship__WEBPACK_IMPORTED_MODULE_0__.ships[i].hit();\n          _ship__WEBPACK_IMPORTED_MODULE_0__.ships[i].isSunk();\n        }\n      }\n    }\n\n    let postHits = this.getTotalHits();\n\n    if (preHits == postHits) {\n      this.logMisses(attackCoords);\n    } else {\n      console.log(\"thats a hit baby\");\n    }\n  }\n\n  getTotalHits() {\n    let tempHits = 0;\n    for (let i = 0; i <= _ship__WEBPACK_IMPORTED_MODULE_0__.ships.length - 1; i++) {\n      tempHits = tempHits + _ship__WEBPACK_IMPORTED_MODULE_0__.ships[i].hits;\n    }\n    return tempHits;\n  }\n\n  logMisses(attackCoords) {\n    for (let i = 0; i < 64; i++) {\n      if (!this.misses[i]) {\n        this.misses[i] = attackCoords;\n        return;\n      }\n    }\n  }\n}\n\n\n//# sourceURL=webpack://weather-app/./src/gameboard.js?");
